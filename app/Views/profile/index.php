                    ...
                    <div class="card profile-card">
                        ...
                        <div class="profile-body">
                            <div class="image-area">
                                <img src="<?php echo base_url() ?>/plugins/images/user-lg.jpg" alt="AdminBSB - Profile Image" />
                            </div>
                                            ...
                                            <div class="panel-heading">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            <img src="<?php echo base_url() ?>/plugins/images/user-lg.jpg" />
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">
                                                            <a href="#"><?php echo $profile['firstname']; ?></a>
                                                        </h4>
                                            ...
                                            <div class="panel-body">
                                                <div class="post">
                                                    ...
                                                    <div class="post-content">
                                                        <img src="<?php echo base_url() ?>/plugins/images/profile-post-image.jpg" class="img-responsive" />
                                                    </div>
                                                </div>
                                            </div>
