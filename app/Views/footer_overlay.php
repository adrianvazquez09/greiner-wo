    ...
    <!-- Custom Js -->
    <script src="<?php echo base_url(); ?>/plugins/js/admin.js"></script>

    <!-- Demo Js -->
    <script src="<?php echo base_url(); ?>/plugins/js/demo.js"></script>
    ...
    <!-- Custom Js -->
    <script src="<?php echo base_url(); ?>/plugins/js/pages/tables/jquery-datatable.js"></script>